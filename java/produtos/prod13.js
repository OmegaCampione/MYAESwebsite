...
var translations = {
  'portuguese': {
    ...
    'textoloja7': 'A "Denim Celestial" combina a atemporalidade do denim com elementos inspirados no cosmos, criando uma peça única e elegante. O denim de alta qualidade proporciona conforto, enquanto os detalhes celestiais, como estrelas bordadas e padrões galácticos, adicionam sofisticação. A tonalidade profunda lembra o azul do céu noturno, e os detalhes cuidadosos, como botões em forma de estrela, elevam esta camisa a um patamar superior de moda. Perfeita para ocasiões especiais ou para um toque celestial no estilo diário.',
  ...
  'english': {
    ...
    'textoloja7': '"Denim Celestial" combines the timelessness of denim with elements inspired by the cosmos, creating a unique and elegant piece. High-quality denim provides comfort, while celestial details like embroidered stars and galactic patterns add sophistication. The deep hue is reminiscent of the blue of the night sky, and the careful details, like star-shaped buttons, elevate this shirt to a higher level of fashion. Perfect for special occasions or for a heavenly touch to everyday style.',
