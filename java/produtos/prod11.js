...
var translations = {
  'portuguese': {
    ...
    'textoloja7': '"Resplendor Opalino" é uma camisa branca que se destaca pela originalidade radiante. Com um toque opalescente, redefine a clássica camisa, conferindo sofisticação moderna. O brilho sutil e elegante adiciona singularidade à peça, perfeita para quem busca estilo distintivo.',
  ...
  'english': {
    ...
    'textoloja7': '"Resplendor Opalino" is a white shirt that stands out for its radiant originality. With an opalescent touch, it redefines the classic shirt, giving it modern sophistication. The subtle and elegant shine adds uniqueness to the piece, perfect for those looking for a distinctive style.',
